...
static const char qt_meta_stringdata_PointEditor[] = {
    "PointEditor\0\0warning(QString)\0"
};
...
const QMetaObjectExtraData PointEditor::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject PointEditor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PointEditor,
      qt_meta_data_PointEditor, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &PointEditor::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PointEditor))
...
// SIGNAL 0
void PointEditor::warning(QString _t1)
{
